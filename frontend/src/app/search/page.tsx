      ...
      <Layout>
        <div className="container-responsive animate-fade-in">
          ...
          <div className="flex gap-8 min-h-screen">
            ...
            {/* Mobile Sidebar */}
            <div className={`mobile-sidebar lg:hidden ${sidebarOpen ? 'open' : ''}`}>
              <div 
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <button
                          key={key}
                          onClick={() => {
                            setMediaType(key as 'all' | 'movies' | 'tv' | 'books');
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="lg:hidden mb-6">
                {searchQuery && (
                  <p className="text-gray-400 text-sm mobile-text-center">
                    Showing results for &quot;<span className="text-white font-medium">{searchQuery}</span>&quot; 
                    • {filteredMedia.length} matches found
                  </p>
                )}
              ...
              <div className="mt-8 lg:mt-12 text-center">
                <div className="glass-effect rounded-2xl p-6 lg:p-8 border border-gray-700">
                  <h3 className="text-xl lg:text-2xl font-bold text-white mb-3 lg:mb-4">Want More Personalized Results?</h3>
                  <p className="text-gray-300 mb-4 lg:mb-6 max-w-2xl mx-auto text-sm lg:text-base">
