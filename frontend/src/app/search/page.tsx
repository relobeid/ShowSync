...
export default function SearchPage() {
  ...
  const handleMediaTypeSelect = (type: 'all' | 'movies' | 'tv' | 'books') => {
    setMediaType(type);
    setSidebarOpen(false); // Close sidebar on mobile after selection
  };
    ...
    <ProtectedRoute>
      <Layout>
        <div className="min-h-screen animate-fade-in">
          {/* Mobile Header */}
          <div className="lg:hidden bg-gray-900/50 backdrop-blur-sm border-b border-gray-800 px-4 py-3 mb-6">
          ...
          <div className="flex gap-6 lg:gap-8">
            {/* Desktop Sidebar */}
            <div className="hidden lg:block w-80 glass-effect rounded-2xl p-6 h-fit sticky top-24 border border-gray-700">
            ...
            {sidebarOpen && (
              <div className="lg:hidden mobile-sidebar open" onClick={() => setSidebarOpen(false)}>
                <div className="mobile-sidebar-content" onClick={(e) => e.stopPropagation()}>
                  <div className="p-4 border-b border-gray-700 bg-gray-800">
                    <div className="flex items-center justify-between">
                      <h2 className="text-lg font-bold text-white flex items-center">
                        <div className="movie-reel w-5 h-5 mr-2 scale-75"></div>
                        Browse & Discover
                      </h2>
                      <button
                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <button
                            key={key}
                            onClick={() => handleMediaTypeSelect(key as 'all' | 'movies' | 'tv' | 'books')}
                            className={`w-full text-left px-3 py-2 rounded-lg transition-all duration-200 ${
                              mediaType === key
                                ? 'bg-red-600 text-white shadow-lg'
                                : 'text-gray-300 hover:text-white hover:bg-gray-800'
                    ...
                    {/* Mobile AI Taste Profile Section */}
                    <div className="mt-6 ai-glow rounded-xl p-4">
                      <h3 className="font-semibold text-white mb-2 flex items-center">
                        <span className="w-2 h-2 bg-red-500 rounded-full animate-pulse mr-2"></span>
                        AI Taste Profile
                      </h3>
            ...
            {/* Main Content Area */}
            <div className="flex-1 mobile-px-4">
              {/* Desktop Header */}
              ...
              <div className="mt-12 text-center">
                <div className="glass-effect rounded-2xl p-6 sm:p-8 border border-gray-700">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Want More Personalized Results?</h3>
                  ...
                  <button className="btn-primary px-6 sm:px-8 py-3 w-full sm:w-auto">
