...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <div className={`theater-curtains ${showCurtains ? 'curtains-visible' : 'curtains-hidden'} spotlight relative flex items-center justify-center pt-24`} style={{ minHeight: 'calc(100vh - 88px)' }}>
        {/* Floating Media Symbols */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {/* Left side floating symbols */}
          <div className="absolute left-32 top-1/4 w-16 h-16 opacity-10 animate-bounce text-gray-400" style={{ animationDelay: '0s', animationDuration: '3s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M18 4l2 4h-3l-2-4h-2l2 4h-3l-2-4H8l2 4H7L5 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4h-4z"/>
            </svg>
          </div>
          <div className="absolute left-48 top-1/2 w-12 h-12 opacity-20 animate-bounce text-blue-400" style={{ animationDelay: '1s', animationDuration: '4s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zm-10-7l5 3-5 3V9z"/>
            </svg>
          </div>
          <div className="absolute left-40 top-3/4 w-14 h-14 opacity-15 animate-bounce text-green-400" style={{ animationDelay: '2s', animationDuration: '3.5s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/>
            </svg>
          </div>
          <div className="absolute left-60 top-1/3 w-10 h-10 opacity-25 animate-bounce text-purple-400" style={{ animationDelay: '0.5s', animationDuration: '4.5s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute left-28 top-2/3 w-12 h-12 opacity-20 animate-bounce text-yellow-400" style={{ animationDelay: '1.5s', animationDuration: '3.8s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute right-32 top-1/4 w-14 h-14 opacity-15 animate-bounce text-red-400" style={{ animationDelay: '2.5s', animationDuration: '3.2s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M21 6H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-10 7.5v-3l4 1.5-4 1.5z"/>
            </svg>
          </div>
          <div className="absolute right-48 top-1/2 w-16 h-16 opacity-10 animate-bounce text-pink-400" style={{ animationDelay: '3s', animationDuration: '4.2s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/>
            </svg>
          </div>
          <div className="absolute right-40 top-3/4 w-12 h-12 opacity-20 animate-bounce text-indigo-400" style={{ animationDelay: '0.8s', animationDuration: '3.7s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
            </svg>
          </div>
          <div className="absolute right-60 top-1/3 w-10 h-10 opacity-25 animate-bounce text-teal-400" style={{ animationDelay: '1.8s', animationDuration: '4.1s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute right-28 top-2/3 w-14 h-14 opacity-15 animate-bounce text-orange-400" style={{ animationDelay: '2.2s', animationDuration: '3.9s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Background sparkles */}
          <div className="absolute left-1/4 top-1/6 w-6 h-6 opacity-10 animate-pulse text-yellow-300" style={{ animationDelay: '4s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
          </div>
          <div className="absolute right-1/4 top-1/6 w-6 h-6 opacity-10 animate-pulse text-yellow-300" style={{ animationDelay: '5s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
          </div>
          <div className="absolute left-1/3 bottom-1/6 w-4 h-4 opacity-15 animate-pulse text-blue-200" style={{ animationDelay: '6s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
          </div>
          <div className="absolute right-1/3 bottom-1/6 w-4 h-4 opacity-15 animate-pulse text-blue-200" style={{ animationDelay: '7s' }}>
            <svg fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
          </div>
                 ...
                 <div className="relative z-20 text-center animate-fade-in w-full px-4">
          <div className="text-center mb-6">
            <div className="text-7xl lg:text-8xl font-bold text-white mb-3">Your AI</div>
            <div className="text-8xl lg:text-9xl font-bold h-20 flex items-center justify-center mb-3">
                <span 
            ...
            <div className="text-7xl lg:text-8xl font-bold text-white mb-4">Club</div>
          </div>
          
          <p className="text-xl text-gray-300 mb-3 max-w-4xl mx-auto leading-snug">
          ...
          <p className="text-base text-yellow-300 mb-6 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button className="btn-primary text-lg px-8 py-4 ai-glow transform hover:scale-105 transition-all duration-200">
      ...
      {/* Film Strip Divider */}
      <div className="film-strip h-8 mb-8 opacity-60 mt-8"></div>

      {/* How ShowSync Works */}
      <div className="mb-16 py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="relative p-8 text-center animate-fade-in rounded-2xl overflow-hidden" style={{ 
            animationDelay: '0.2s',
            ...
            <div className="absolute top-4 right-4 w-12 h-12 opacity-20 text-cyan-400">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute bottom-4 left-4 w-8 h-8 opacity-30 text-green-400">
              <svg fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2L13.09 8.26L22 9L16 14L18 23L12 19L6 23L8 14L2 9L10.91 8.26L12 2Z"/>
              </svg>
            </div>
            <div className="absolute top-1/2 left-2 w-6 h-6 opacity-25 text-cyan-300">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative mb-6">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-cyan-300" style={{ boxShadow: '0 0 20px rgba(0, 255, 255, 0.5)' }}>
                {/* Alien Figure */}
              ...
              <div className="absolute -top-2 -right-2 w-10 h-10 bg-green-400 rounded-full flex items-center justify-center text-xs font-bold animate-pulse border-2 border-white">
                AI
              </div>
            </div>
            <h3 className="text-2xl font-bold mb-4 text-cyan-300" style={{ textShadow: '0 0 10px rgba(0, 255, 255, 0.5)' }}>
              Rate Your Universe
            </h3>
          ...
          <div className="relative p-8 text-center animate-fade-in rounded-2xl overflow-hidden" style={{ 
            ...
            <div className="absolute top-4 right-4 w-12 h-12 opacity-30 text-yellow-300">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute bottom-4 left-4 w-10 h-10 opacity-40 text-orange-300">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute top-1/2 right-2 w-6 h-6 opacity-25 text-yellow-400">
              <svg fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2L13.09 8.26L22 9L16 14L18 23L12 19L6 23L8 14L2 9L10.91 8.26L12 2Z"/>
              </svg>
            </div>
            <div className="absolute bottom-1/3 right-6 w-8 h-8 opacity-30 text-green-600">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative mb-6">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-yellow-600 to-orange-700 rounded-full flex items-center justify-center shadow-2xl border-4 border-yellow-400" style={{ boxShadow: '0 0 20px rgba(255, 215, 0, 0.6)' }}>
                {/* Cowboy Silhouette */}
                <svg className="w-14 h-14 text-white" fill="currentColor" viewBox="0 0 100 100">
                  {/* Cowboy Hat */}
              ...
              <div className="absolute -top-2 -right-2 w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-xs font-bold animate-pulse border-2 border-white">
                SYNC
              </div>
            </div>
            <h3 className="text-2xl font-bold mb-4 text-yellow-300" style={{ textShadow: '0 0 10px rgba(255, 215, 0, 0.5)' }}>
              Round Up Your Posse
            </h3>
          ...
          <div className="relative p-8 text-center animate-fade-in rounded-2xl overflow-hidden" style={{ 
            ...
            <div className="absolute bottom-4 left-4 w-8 h-8 opacity-40 text-pink-300">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute top-1/2 left-2 w-6 h-6 opacity-25 text-purple-200">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute bottom-1/3 right-6 w-8 h-8 opacity-35 text-orange-300">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative mb-6">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-pink-500 to-purple-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-pink-300" style={{ boxShadow: '0 0 20px rgba(255, 20, 147, 0.6)' }}>
              ...
              <div className="absolute -top-2 -right-2 w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center text-xs font-bold animate-pulse border-2 border-white text-black">
                NOW
              </div>
            </div>
            <h3 className="text-2xl font-bold mb-4 text-white" style={{ textShadow: '0 0 10px rgba(255, 20, 147, 0.8)' }}>
              Anime Community
            </h3>
      ...
      <div className="mb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-white mb-3">By the Numbers</h3>
            <p className="text-gray-400">What happens when taste meets technology</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="flex items-center justify-center mb-4">
                ...
                <div className="text-3xl font-bold gradient-text">47s</div>
              </div>
              <div className="text-gray-300 font-medium mb-1">Average Match Time</div>
              <div className="text-sm text-gray-500">Speed of AI taste matching</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-gray-300 font-medium mb-1">Accuracy Rate</div>
              <div className="text-sm text-gray-500">Users satisfied with matches</div>
            </div>

            <div className="text-center group">
              <div className="flex items-center justify-center mb-4">
                <div className="w-3 h-3 bg-red-500 rounded-full mr-3"></div>
                <div className="text-3xl font-bold gradient-text">7.3h</div>
              </div>
              <div className="text-gray-300 font-medium mb-1">Weekly Engagement</div>
              <div className="text-sm text-gray-500">Hours in community discussions</div>
            </div>
          </div>
        </div>
      </div>
